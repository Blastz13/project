...
public final class FragmentMyCartBinding implements ViewBinding {
  ...
  private FragmentMyCartBinding(@NonNull ConstraintLayout rootView, @NonNull Button cartContinueBtn,
      @NonNull RecyclerView cartItemsRecyclerview, @NonNull LinearLayout endCart,
  ...
  public static FragmentMyCartBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentMyCartBinding((ConstraintLayout) rootView, cartContinueBtn,
