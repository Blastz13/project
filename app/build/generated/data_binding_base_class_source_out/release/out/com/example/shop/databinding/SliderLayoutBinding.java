...
public final class SliderLayoutBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView bannerSlider;

  private SliderLayoutBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView bannerSlider) {
  ...
  public static SliderLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ImageView bannerSlider = ViewBindings.findChildViewById(rootView, id);
      if (bannerSlider == null) {
        break missingId;
      }

      return new SliderLayoutBinding((ConstraintLayout) rootView, bannerSlider);
    }
